...
export function AvailabilityPanel({ title, region, subscriptions }: Props) {
  ...
  return <div className="panel h-fit rounded-2xl p-5 sm:p-7">
    ...
    <div className="mt-5 flex items-center gap-2 border-t hairline pt-4 text-[10px] leading-5 text-[#707283]"><SlidersHorizontal size={13} className="shrink-0" /> Region and subscriptions are controlled from Settings. Availability data is source-backed; missing data is never treated as confirmed.</div>
  </div>;
}
